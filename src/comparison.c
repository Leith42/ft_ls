...
/*   Updated: 2017/09/11 13:23:45 by aazri            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (a->statbuf.st_birthtimespec.tv_nsec != \
		b->statbuf.st_birthtimespec.tv_nsec)
	{
		return (a->statbuf.st_birthtimespec.tv_nsec < \
			b->statbuf.st_birthtimespec.tv_nsec);
	}
	if (a->statbuf.st_birthtimespec.tv_sec != \
		b->statbuf.st_birthtimespec.tv_sec)
	{
		return (a->statbuf.st_birthtimespec.tv_sec < \
			b->statbuf.st_birthtimespec.tv_sec);
	}
	return (ft_strcmp(a->path, b->path));
}
